...
namespace CrmSample.UILayer.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public EmployeeController(IEmployeeService employeeService, ICategoryService categoryService)//categorileri listelemk istediğim için önce yukarda bu listeye ait metotları dahil ettim (priv readon), sonra bu satıra dep inj aldım.
        {
